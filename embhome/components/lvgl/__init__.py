...
- Platform subdirs: switch, select, text, widgets, binary_sensor, sensor, number, text_sensor, light

Dependencies: display
Auto-load: key_provider
...
def validate_component_not_implemented(config):
    raise cv.Invalid(
        "Component 'lvgl' is not yet implemented in embhome. "
