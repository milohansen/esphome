"""
Component: modbus_controller
Status: NOT IMPLEMENTED

Structure:
- Platform types: component
- Has platform dirs: True
- Platform subdirs: switch, select, binary_sensor, sensor, number, text_sensor, output
...
def validate_component_not_implemented(config):
    raise cv.Invalid(
        "Component 'modbus_controller' is not yet implemented in embhome. "
