...
- Platform subdirs: switch, binary_sensor, sensor, text_sensor, output

Dependencies: uart
Auto-load: binary_sensor, text_sensor, sensor, switch, output
...
def validate_component_not_implemented(config):
    raise cv.Invalid(
        "Component 'pipsolar' is not yet implemented in embhome. "
